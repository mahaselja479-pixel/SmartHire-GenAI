...
if menu == "🏠 Home":
    ...
    st.subheader("AI Powered Resume Analyzer & Job Recommendation System")
    ...
    st.success("🚀 Upload your resume and start exploring AI-powered career assistance.")
# ==============================
# RESUME PARSER
# ==============================
    ...
    mime="application/json"
        ...
        st.caption(f"⚡ Parsed in {end-start:.2f} seconds")
        
        st.markdown("## 📊 Resume Overview")

        col1, col2, col3, col4 = st.columns(4)

        col1.metric("🛠 Skills", len(result.get("skills", [])))
        col2.metric("🎓 Education", len(result.get("education", [])))
        col3.metric("💼 Experience", len(result.get("experience", [])))
        col4.metric("📜 Certifications", len(result.get("certifications", [])))
...
"""
            ...
            st.warning("Experience details not found.")
        ...
        if len(jobs) == 0:
            ...
            for index, job in enumerate(jobs):
                ...
                with col1:
                    ...
                    st.subheader(f"💼 {job.get('title','Unknown Job')}")
                ...
                progress_value = max(0.0, min(score / 100, 1.0))
...
# ==============================
    ...
    if uploaded_file is not None:
        ...
        st.subheader("🤖 AI Detailed Feedback")
...
# ==============================
    ...
    mime="text/plain"
        ...
        st.info(
            "💡 Practice answering these questions aloud to improve confidence."
        )
...
# ==============================
    ...
    st.caption("Ask career-related questions and receive AI-powered guidance.")
...
st.markdown(
    ...
    AI Powered Resume Analyzer & Job Recommendation System<br><br>
    Built with ❤️ using Streamlit, Groq LLM, Sentence Transformers & RAG
    </center>
    """,
    unsafe_allow_html=True
)